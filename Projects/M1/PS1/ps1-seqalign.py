...
## my scoring matrix, taken from the lecture
S = [
	# A  G   C   T
	[ 1,  0, -1, -1], # A
	[ 0,  1, -1, -1], # G
...
def main():
	...
	file1 = sys.argv[1]		# "human_HoxA13.fa"
	file2 = sys.argv[2]		# "mouse_HoxA13.fa"
	...
	if isOkay:
		...
		print "First mismatch at ", mismatches[0]
		subs1 = []
		subs2 = []
		for i in range(-2,3):
			subs1.append(s1[mismatches[0]+i])
			subs2.append(s2[mismatches[0]+i])
		print subs1
		print subs2
		print "--------"
		print "F = "
		print F[mismatches[0]-1][mismatches[0]-1], " | ", F[mismatches[0]-1][mismatches[0]]
		print F[mismatches[0]][mismatches[0]-1], " | ", F[mismatches[0]][mismatches[0]]
